...
//
//     final shopXModel = shopXModelFromJson(jsonString);

import 'dart:convert';

List<ShopXModel> shopXModelFromJson(String str) =>
    List<ShopXModel>.from(json.decode(str).map((x) => ShopXModel.fromJson(x)));

String shopXModelToJson(List<ShopXModel> data) =>
...
class ShopXModel {
  ...
  factory ShopXModel.fromJson(Map<String, dynamic> json) => ShopXModel(
        id: json["id"],
        brand: json["brand"],
        name: json["name"],
        price: json["price"],
